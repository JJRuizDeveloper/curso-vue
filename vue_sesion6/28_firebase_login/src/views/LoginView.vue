<template>
    <div class="login-form-container">
        <form class="login-form" @submit.prevent="login">
            <input type="text" placeholder="Username / Email" v-model="user"  class="login-form-input"/>
            <input type="password" placeholder="Password" v-model="pass" class="login-form-input" />
